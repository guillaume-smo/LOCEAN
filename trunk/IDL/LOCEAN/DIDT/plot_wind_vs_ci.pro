...
; lecture var 1D+2D
restore, pathin+var_nam+'_1D_'+rayon+'km_'+expname+'_'+freq+'_IO_'+datebeg+'-'+dateend+'.dat', /VERBOSE
d1_var = D1_VAR_BEFORE & help, d1_var
...
xyouts, 0.15, 0.15, var_nam+'_ICR - DEC', /normal, color=250, charsize=1.5
...
saveimage, 'FIGS_PDF/pdf_wind_bin'+strtrim(bin_size,2)+'_'+var_nam+'-BEF1D_'+rayon+'km_int+dec_'+exp+'.gif'
ENDIF
...
xrange=[bin[min(iok)],bin[max(iok)+1]],linestyle=2;,yrange=[ymin,ymax]
