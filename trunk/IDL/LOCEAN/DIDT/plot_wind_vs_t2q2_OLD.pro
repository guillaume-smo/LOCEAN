...
IF var_nam EQ 'T2' THEN d1_var = m_mean(m_mean(temporary(dxy_var_wsc_rot-273.15),dim=4,/nan),dim=3,/nan); - temporary(d1_var_before)
IF var_nam EQ 'Q2' THEN d1_var = m_mean(m_mean(temporary(dxy_var_wsc_rot*1000.),dim=4,/nan),dim=3,/nan)
