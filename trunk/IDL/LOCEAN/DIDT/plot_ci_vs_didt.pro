...
IF var_typ EQ 'DUR' THEN d1_var = d1_var_during
...
;saveimage, 'FIGS_PDF/pdf_'+bin_name+'_bin'+strtrim(bin_size,2)+'_dUVdt_all_'+exp+'.gif'
;ENDIF
...
oplot, bin_mid[iok], dwinddt_allper[0,iok], linestyle=2, color=250, thick=1
oplot, bin_mid[iok], dwinddt_allper[1,iok], linestyle=2, color=250, thick=1
saveimage, 'FIGS_PDF/pdf_'+bin_name+'_'+var_typ+'_bin'+strtrim(bin_size,2)+'_dUVdt_int+dec_'+exp+'.gif'
ENDIF
