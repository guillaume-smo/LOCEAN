...
;file_in2 = '/net/adonis/usr/adonis/varclim/gslod/EXP_'+ expname +'/T/tpot700_'+ period +'.nc' & help, file_in2
;file_in3 = '/net/adonis/usr/adonis/varclim/gslod/EXP_'+ expname +'/T/tpot500_'+ period +'.nc' & help, file_in3
;file_in4 = '/net/adonis/usr/adonis/varclim/gslod/EXP_'+ expname +'/T/tpot300_'+ period +'.nc' & help, file_in4
file_in2 = '/net/adonis/usr/adonis/varclim/gslod/EXP_'+ expname +'/TRACKER/temp_mean_700-300_'+period+'.nc' & help, file_in2
...
print, timedate[0], timedate[n_elements(timedate)-1]
...
;t700t = read_ncdf('tpot', t, t, TIMESTEP=1, FILENAME=file_in2, /NOSTRUCT) & help, t700t
;t500t = read_ncdf('tpot', t, t, TIMESTEP=1, FILENAME=file_in3, /NOSTRUCT) & help, t500t
;t300t = read_ncdf('tpot', t, t, TIMESTEP=1, FILENAME=file_in4, /NOSTRUCT) & help, t300t
tmeant = read_ncdf(temptype, t, t, TIMESTEP=1, FILENAME=file_in2, /NOSTRUCT) & help, tmeant
...
;    tempenvi = (mean(t700t[indenvi], /NAN) + mean(t500t[indenvi], /NAN) + mean(t300t[indenvi], /NAN)) / 3.
    tempcore = mean(tmeant[indcore], /NAN) 
    tempenvi = mean(tmeant[indenvi], /NAN)
...
save, loncyc, latcyc, mslpcyc, lonuvcyc, latuvcyc, uv10cyc, lonvorcyc, latvorcyc, $
      ...
      filename = path_data +'maxima_'+temptype+'_nico_radius_u'+ strtrim(long(ucrit),2) +'_v'+ strtrim(long(vorcrit*100000),2) +'_t'+ strtrim(long(tempcrit*10),2) +'_'+ strtrim(long(date_deb),2) +'-'+ strtrim(long(date_fin),2) +'.idl'
