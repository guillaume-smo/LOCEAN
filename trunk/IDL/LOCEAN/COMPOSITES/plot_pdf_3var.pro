PRO plot_pdf_3var
  ...
  path_dir_postpro = '/Users/gslod/WORK/IDL/COLLOCALISATION/EXP_'+expname+'/DATA/'
  pathfig = '/Users/gslod/WORK/IDL/COLLOCALISATION/FIGS_PDF/'
...
;  var2_bin  = bin1_deb+findgen(bin1_num)*bin1_size
  ...
  IF expname EQ 'IBTRACS' THEN BEGIN
    restore, path_dir_postpro + 'd1_TRACKS_'+expname+'_'+basin+'_'+datebeg_tc+'-'+dateend_tc+'.dat', /VERBOSE    
    IF var2_name EQ 'SST' THEN restore, path_dir_postpro + 'SST_'+expname+'_'+freq+'_'+basin+'_'+datebeg_sf+'-'+dateend_sf+'.dat', /VERBOSE
  ENDIF ELSE BEGIN
    restore, path_dir_postpro + 'd1_TRACKS_'+expname+'_IO_'+datebeg_tc+'-'+dateend_tc+'.dat', /VERBOSE        
    IF var2_name EQ 'SST' THEN restore, path_dir_postpro + 'SST_'+expname+'_'+freq+'_IO_'+datebeg_tc+'-'+dateend_tc+'.dat', /VERBOSE
  ENDELSE
