; $Id: //depot/Release/ENVI50_IDL82/idl/idldir/lib/hist_2d.pro#1 $
;
; Copyright (c) 1992-2012, Exelis Visual Information Solutions, Inc. All
...
function hist2d, im1, im2, $
    ...
    im1max = MAX(im1, MIN=im1min, /NAN) & print, im1min, im1max
    im2max = MAX(im2, MIN=im2min, /NAN) & print, im2min, im2max
    ...
    im1bins = FLOOR((max1-min1) / b1) + 1L & print, im1bins
    im2bins = FLOOR((max2-min2) / b2) + 1L & print, im2bins
    STOP
