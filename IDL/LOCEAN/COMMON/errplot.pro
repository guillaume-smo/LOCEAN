; $Id: //depot/idl/IDL_71/idldir/lib/errplot.pro#1 $
;
...
;-
Pro Errplot, X, Low, High, Width = width, Thick = thick, $
...
for i=0,n-1 do begin            ;do each point.
    ...
    plots, [xy0[0] + [-w, w,0], xy1[0] + [0, -w, w]], $
      ...
      /DEVICE, NOCLIP=noclip, PSYM=0, THICK=thick, _STRICT_EXTRA=_extra
endfor
end
