...
; lecture best-track
restore, 'dist_tc_200km.idl', /verbose
...
saveimage, 'FIGS_PDF/pdf_wind_bin'+strtrim(bin_size,2)+'_'+var_nam+'_int+dec_'+exp+'.gif'
ENDIF
