; docformat = 'rst'
;+
; Creates an inventory of a GRIB1/2 file, returned as a string array.
; Modeled on the indispensible "wgrib/wgrib2" with the "-s" option.
;
; :params:
...
;
; :todo:
;  Add option to write to a text file.
;  
; :author:
;	Mark Piper, VIS, 2012
;
...
;  
; :version:
;  $Id: grib_inventory.pro 593 2012-08-28 15:24:56Z mpiper $
;-
function grib_inventory, grib_file, multi_support=multi, debug=debug
   ...
   if !version.release lt 8.1 or !version.os_family eq 'Windows' then begin
